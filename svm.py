...
print('')
print('Interaction Gender / Adult:')
...
print ('')
print ('Classifying using LinearSVC with only Gender and Class...')
print ('======================================================================')

print ('')
print ('Computing the SVM prediction.')
X = train_df[['Gender','Pclass']].values
